...
import com.github.srad.infernorunner.entity.animation.AbstractAnimator
...
abstract class AbstractEntity(modelResource: Resource<Model>) : ModelInstance(modelResource.load), IGameLoopListener {
    companion object {
    ...
    /** Squared (not euclidean) distance to another model. Notice it's the squared distance. */
    fun distanceTo(a: AbstractEntity) = translation.sub(a.translation).len2()
