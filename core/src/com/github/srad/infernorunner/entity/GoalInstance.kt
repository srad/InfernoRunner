...
class ShieldInstance : PhysicalModelInstance(Resource.shieldModel, PhysicalAttributes(btCylinderShape(Vector3(4f, 0.2f,4f)), 0f, CollisionMasks(PlayerInstance::class))) {
...
class GoalInstance : PhysicalModelInstance(Resource.goalModel, PhysicalAttributes(btSphereShape(2f), 0f, CollisionMasks(PlayerInstance::class))), IMappable {
    override val name = "Shield"
